        ...
        <section className="surface-panel fade-rise-delay-1">
          ...
          <div className="mt-7 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              ["04", "Explainable risk impact", "Input: latest stock price, volume, recent trend, drawdown, variability, unusual activity, gold, crude oil, and VIX.", "Classifies the current combined financial-market risk as LOW, MEDIUM, or HIGH and identifies which stock or global indicators contributed most to that result.", "Novelty: combines stock risk classification with gold, oil, and global-market stress, then uses feature-level explanation to show why the category was produced instead of returning an unexplained label. The reproducible CSE model supports both BIL and JKH and achieved 0.859 macro-F1 on a chronological holdout; this measures current-risk label fidelity, not future-return prediction."],
