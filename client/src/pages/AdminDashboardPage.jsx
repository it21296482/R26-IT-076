        ...
        <section className="surface-panel fade-rise-delay-1">
          ...
          <div className="mt-7 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              ["04", "Clear stock picture", "Input: the three evidence packages produced above.", "Balances price potential, adverse ranges, company performance, external pressure, uncertainty, and change conditions in plain language.", "Novelty: the contribution is a human-centred explanation framework, not merely a static dashboard. The unified result is integrated; comparing visual-only, visual-plus-explanation, factor, event, and risk formats through comprehension, trust, usability, and cognitive-load studies remains the formal research evaluation."],
